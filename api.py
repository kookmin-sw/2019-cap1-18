...
#print("pm25 Grade : " + pm25Grade.text + "\n")
 ...
 #api 값 저장
 collection.insert({"location": "정릉로", "elat": 37.603807, "elng": 127.025997, "epm10value" : pm10Value.text, "epm10grade": pm10Grade.text, "epm25value": pm25Value.text, "epm25grade": pm25Grade.text, "edate": dataTime.text})
...
# print (result)
 ...
 #dust.recent document update
 collection = db.get_collection('recent')
 collection.update({"idnum": "A-0001"}, {"$set": {"elat": 37.603807, "elng": 127.025997, "epm10value" : pm10Value, "epm10grade": pm10Grade, "epm25value": pm25Value, "epm25grade": pm25Grade, "edate": dataTime.text}})
 collection.update({"idnum": "A-0002"}, {"$set": {"elat": 37.603807, "elng": 127.025997, "epm10value" : pm10Value, "epm10grade": pm10Grade, "epm25value": pm25Value, "epm25grade": pm25Grade, "edate": dataTime.text}})
 collection.update({"idnum": "A-0003"}, {"$set": {"elat": 37.603807, "elng": 127.025997, "epm10value" : pm10Value, "epm10grade": pm10Grade, "epm25value": pm25Value, "epm25grade": pm25Grade, "edate": dataTime.text}})
